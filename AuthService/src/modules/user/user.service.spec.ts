...
describe('UserService', () => {
  ...
  it("should authenticate user and return access and refresh tokens if user exists and password is correct", async () => {
    ...
    expect(tokenServiceMock.generateAccessToken).toHaveBeenCalledWith(1, userLoginDto.email);
    expect(tokenServiceMock.generateRefreshToken).toHaveBeenCalledWith(1, userLoginDto.email);
  ...
  it("should create new user and return access and refresh tokens if user does not exist", async () => {
    ...
    userRepositoryMock.save.mockResolvedValue({ id: 1, ...userRegisterDto });
    ...
    expect(tokenServiceMock.generateAccessToken).toHaveBeenCalledWith(1, userRegisterDto.email);
    expect(tokenServiceMock.generateRefreshToken).toHaveBeenCalledWith(1, userRegisterDto.email);
    expect(tokenServiceMock.saveToken).toHaveBeenCalledWith(1, expectedTokens.refreshToken);
  });
