...
import { GATEWAY_AUTH_SERVICE, GATEWAY_CHAT_SERVICE, GATEWAY_NOTIFICATION_SERVICE, GATEWAY_TICKET_SERVICE, GATEWAY_TRAIN_SERVICE } from './constants/services.constants';
import { GATEWAY_AUTH_QUEUE, GATEWAY_NOTIFICATION_QUEUE, GATEWAY_TICKET_QUEUE, GATEWAY_TRAIN_QUEUE, GATEWAY_CHAT_QUEUE } from '@app/queries';
import { JwtStrategy } from './strategy/jwt.strategy';
import { EmailtServiceController } from './controllers/email-service.controller';
import { ScheduleModule } from '@nestjs/schedule';
import { ChatServiceController } from './controllers/chat-service.controller';
...
@Module({
  imports: [RmqModule.register([
    ...
    { name: GATEWAY_CHAT_SERVICE, queue: GATEWAY_CHAT_QUEUE }]),
  ScheduleModule.forRoot(),],
  controllers: [TrainServiceController, AuthServiceController, TicketServiceController, EmailtServiceController, ChatServiceController],
