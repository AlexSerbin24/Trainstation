...
import { CHAT_TRAIN_QUEUE, GATEWAY_TRAIN_QUEUE, TICKET_TRAIN_QUEUE } from '@app/queries';
...
async function bootstrap() {
  ...
  app.connectMicroservice(RmqService.getOptions([rmqUrl], CHAT_TRAIN_QUEUE, true));
