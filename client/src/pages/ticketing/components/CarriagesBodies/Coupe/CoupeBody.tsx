...
import CoupePlaces from './CoupePlaces.tsx';
...
const CoupeBody: React.FC<Props> = ({ places, onSelectPlace, selectedPlaces }) => {
    return (
        <svg style={{ alignSelf: "center" }} width="880" height="120" xmlns="http://www.w3.org/2000/svg">
            ...
            <CoupePlaces places={places} onSelectPlace={onSelectPlace} selectedPlaces={selectedPlaces} />
        </svg>
    );
}

export default CoupeBody;
